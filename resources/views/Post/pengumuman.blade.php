          ...
          <article class="blog-entry">
            <div class="entry-header">
              <div class="post-thumbnail">
                <img src="{{asset('storage/'.$pengumuman->photo)}}" alt="">
              </div>
              <div class="post-date">
            ...
            <div class="post-title">{{$pengumuman->title}}</div>
            ...
            <a href="{{ route('postdetail',$pengumuman->id) }}" class="btn btn-primary button">Continue Reading</a>
          </article>
          @endforeach
        </div>
        <!-- Sidebar -->
